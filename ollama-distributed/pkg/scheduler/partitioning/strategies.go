...
type PartitionTask struct {
	...
	Model     *server.Model          `json:"model"`
	Options   api.Options            `json:"options"`
	Nodes     []*NodeInfo            `json:"nodes"`
	GGML      *ggml.GGML             `json:"ggml"`
...
func (pm *PartitionManager) SelectStrategy(task interface{}, model *server.Model, opts api.Options) (string, error) {
