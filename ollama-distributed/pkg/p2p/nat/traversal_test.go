...
func (m *mockNetConn) LocalAddr() net.Addr               { return &net.UDPAddr{IP: net.ParseIP("127.0.0.1"), Port: 8080} }
func (m *mockNetConn) RemoteAddr() net.Addr              { return &net.UDPAddr{IP: net.ParseIP("127.0.0.1"), Port: 8081} }
