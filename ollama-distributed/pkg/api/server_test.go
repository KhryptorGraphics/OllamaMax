...
func (m *MockP2PNode) ConnectedPeers() []peer.ID {
	args := m.Called()
	return args.Get(0).([]peer.ID)
}
...
func (m *MockSchedulerEngine) GetNodes() map[string]*scheduler.NodeInfoInfo {
	args := m.Called()
	return args.Get(0).(map[string]*scheduler.NodeInfoInfo)
}

func (m *MockSchedulerEngine) GetAllModels() map[string]*scheduler.ModelInfoInfo {
	args := m.Called()
	return args.Get(0).(map[string]*scheduler.ModelInfoInfo)
}

func (m *MockSchedulerEngine) GetModel(name string) (*scheduler.ModelInfoInfo, bool) {
	args := m.Called(name)
	return args.Get(0).(*scheduler.ModelInfoInfo), args.Bool(1)
}

func (m *MockSchedulerEngine) GetAvailableNodes() []*scheduler.NodeInfoInfo {
	args := m.Called()
	return args.Get(0).([]*scheduler.NodeInfoInfo)
}
