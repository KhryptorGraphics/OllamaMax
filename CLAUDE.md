...
Serena MCP server is installed and configured for this project:

### Available Capabilities
- **Semantic Code Understanding**: LSP-powered code analysis across 15+ languages
- **Symbol-Level Operations**: Precise code navigation and editing
- **Project Indexing**: Fast semantic search and retrieval
- **Multi-Language Support**: Go, TypeScript/JavaScript, Python, Rust, C/C++, and more

### Usage Guidelines
- **Primary Use Cases**: Symbol operations, code navigation, semantic search
- **Preferred Over**: Manual text search for code understanding
- **Integration**: Works seamlessly with Claude Code and other MCP servers
- **Performance**: Optimized for large codebases and complex projects

### Commands Available
Serena is automatically available through the MCP interface when using Claude Code.
Use Serena for:
- Finding symbol definitions and references
- Navigating complex codebases
- Understanding code relationships
- Performing semantic code operations
